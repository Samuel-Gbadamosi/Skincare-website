...
<body class="container-fluid">
  ...
  <main class="container-fluid">
    <img src="" alt="">
    <div style="background:linear-gradient(90deg,#f75063 0,#f77244 100%);" id="carouselExampleIndicators"
      class="carousel slide pt-4" data-ride="carousel">
      ...
      <div class="row">
        ...
        <div class="col-6 pt-4">
          <div class="mt-5">
            ...
            <div class="myp mt-3">
              <p style="color:black;">consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
                magna aliqua. Ut enim ad minim veniam, quis nostrud exercitationconsectetur adipiscing</p>
            </div>
    ...
    <section class="sect2">
      <div class="text-center">
        ...
        <p style="color:black; font-family: monospace; font-weight: lighter;">Sed do eiusmod tempor incididunt ut labore
        ...
        <div class="col-8">
          <div class="row myrow">
            <div class="col-8">
              ...
              <p style="font-size: 18px; width: 130%; line-height: 1.2; color: #575757;">Lorem ipsum dolor sit amet,
                consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
                ad minim veniam, quis nostrud exercitation ullamco laborisLorem ipsum dolor sit amet, consectetur
      ...
      <div class="row ">
        <div class="col-6 myrow">
          <div class="">
            ...
            <p style="text-align: right; font-size: 18px; width: 101%; line-height: 1.2; color: #575757;">Lorem ipsum
              dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
              aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laborisLorem ipsum dolor sit amet,
            ...
            <div class="col-12">
              <form>
                <div class="form-group">
                  ...
                  <input required type="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
